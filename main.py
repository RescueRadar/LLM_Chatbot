...
def perform_action(option):
    if option == 'Agency Query':
        ...
        components.iframe("http://127.0.0.1:7860", width=800,
        ...
        demo = gradio.Interface(
            fn=CustomChatGPT, inputs="text", outputs="text", title="Calamity chatbot")
        components.iframe("http://127.0.0.1:7862", width=800,
                          height=600, scrolling=True)
...
option_selected = st.radio(
    'Select an option:', ('Agency Query', 'General Query'))
